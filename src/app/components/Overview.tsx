...
const HospitalDashboard = () => {
  return (
    <DashboardWrapper
      dashboardId="728c909f-7dd3-4444-b1f4-d62238c656de"
      title="Overview"
      description="The Overview Dashboard provides a high-level summary of key healthcare metrics and trends across Nigeria. It includes visualizations of patient volume, diagnosis distribution, and intervention patterns, offering a comprehensive view of healthcare utilization and outcomes."
      height="1500px"
